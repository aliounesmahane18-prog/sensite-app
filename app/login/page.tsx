    ...
    <div className="min-h-screen bg-orange-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <p className="text-center text-sm text-gray-500 mt-4">
          Pas de boutique ?{" "}
          <a href="https://wa.me/221767263361?text=Bonjour%20SENsite-APP%2C%20je%20veux%20créer%20ma%20boutique%20en%20ligne" className="text-orange-500 font-semibold">
            Contacte Ali.IA
          </a>
        </p>
      </div>
